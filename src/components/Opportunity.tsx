  ...
  return (
    <Section id="co-hoi">
      ...
      >
        ...
        <br />
        trị giá <em className="font-serif italic text-gradient-gold">2,6 nghìn tỷ đô</em>.
      </h2>

      <p className="text-lg lg:text-xl text-text-body font-light leading-relaxed max-w-3xl mb-14">
        Lớn hơn Canada hay Hàn Quốc. Tesla, SpaceX, Apple, Google, Samsung đều đặt đại bản doanh
        tại đây — kéo theo cả một hệ sinh thái xây dựng và nội thất bùng nổ.
      </p>
